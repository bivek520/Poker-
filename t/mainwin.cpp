...
{	
    ...
    balance1.set_markup("<span size='14000' color ='black' weight='bold' >$  "
                        +  std::to_string(balance) + "</span>");
    balance2.set_markup("<span size='14000' color ='black' weight='bold' >$  "
                        +  std::to_string(balance) + "</span>");
    balance3.set_markup("<span size='14000' color ='black'weight='bold' >$  "
                        +  std::to_string(balance) + "</span>");
    balance4.set_markup("<span size='14000' color ='black'weight='bold' >$  "
                        +  std::to_string(balance) + "</span>");
    balance5.set_markup("<span size='14000' color ='black'weight='bold' >$  "
                        +  std::to_string(balance) + "</span>");
